	    ...
	    return {
	        ...
	        link: function(scope, elem) {
	          ...
	          function fetchDisplayField(termInput,k,recordsArray,nonSyncPostCallCount) {
	          	...
	          	/*var newQueryId = querySrv.set({});
	          	querySrv.list[newQueryId].disable=true;*/
	          	...
	          	boolQuery = boolQuery.should(ejs.QueryStringQuery(scope.panel.field+":"+termInput.term));
	          	//querySrv.list[newQueryId].query=scope.panel.field+":"+termInput.term;
	          	//boolQuery = boolQuery.should(querySrv.list[newQueryId]);
      		  requestDispalyField = requestDispalyField.query(
      			...
      			requestDispalyField.doSearch().then(function(results) {
	      	        ...
	      	        if(scope.query_id === query_id) {
	      	        	...
	      	        	recordsArray[k] = { label : termInput.term , data : [[k,termInputStatName,results.hits.hits[0]._source[displayFieldOfScope]]], actions: true};
